...
public class Library { 
    ...
    public static String library_name;  // static variable    

    public static void display_library_name()  // static method
   {   Scanner sc = new Scanner(System.in); 
        library_name = sc.nextLine();  
      System.out.println("Name of a library  :"+ library_name); 
   }
...
class Book
{ 
   public final String ISBN; // final keyword 
